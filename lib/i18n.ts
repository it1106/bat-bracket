...
export type TKey =
  ...
  | 'statsCountryMatrixGenderLabel'
  | 'statsCountryMatrixAllGenders'
...
const dict: Record<Lang, Record<TKey, string>> = {
  en: {
    ...
    searchHelp: 'Player name, club, event, or round (QF, SF, R16, F). You can use & (and) or | (or) to search — e.g. kba & QF will show only Kasemsak players in the quarter finals.',
    ...
    statsMedalsPerEvent: 'Count medals (doubles = 1)',
  ...
  th: {
    ...
    searchHelp: 'ชื่อนักกีฬา ทีม ประเภทแข่งขัน หรือรอบ (QF, SF, R16, F) สามารถใช้ & (and) หรือ | (or) ในการค้นหาเช่น kba & QF จะแสดงผลทีมเกษมศักดิ์ฯ ในรอบก่อนรองชนะเลิศเท่านั้น',
    ...
    statsMedalsPerEvent: 'นับเหรียญ (คู่ = 1)',
